...
const WhatsAppFloat: React.FC = () => {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 whatsapp-animate bg-whatsapp text-white p-4 rounded-full shadow-lg hover:bg-whatsapp-hover transition-colors flex items-center justify-center group"
