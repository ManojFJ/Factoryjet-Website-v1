      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-navy mt-2">
            Industrial Web Design Services in Mumbai
          </h2>
          <p className="text-slate mt-4 max-w-2xl mx-auto">
            From manufacturer catalogs to B2B e-commerce portals, we build
            websites that generate export leads and grow wholesale orders.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {servicesData.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className={`bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-shadow border border-light flex flex-col ${
                  isFeatured ? "lg:col-span-2 lg:bg-navy" : ""
                }`}
              >
                <div className="mb-6">
                  ...
                  <div
                    className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 ${
                      isFeatured
                        ? "bg-blue-50 text-primary lg:bg-white/10 lg:text-accent"
                  ...
                  <h3
                    className={`text-2xl font-bold mb-2 ${
                      isFeatured ? "text-navy lg:text-white" : "text-navy"
                    }`}
                  >
                    {service.title}
                  </h3>
                  <p
                    className={`text-sm mt-2 italic ${
                      isFeatured ? "text-slate lg:text-white/70" : "text-slate"
                    }`}
                  >
                ...
                <p
                  className={`text-sm mb-6 leading-relaxed ${
                    isFeatured ? "text-slate lg:text-white/80" : "text-slate"
                  }`}
                >
                  {service.description}
                </p>
                ...
                <button
                  className={`w-full py-3 rounded-lg font-bold transition-colors ${
                    isFeatured
                      ? "bg-secondary text-white hover:bg-orange-600 lg:hover:bg-white lg:hover:text-navy"
...
const ROICalculator = () => {
  ...
  const [businessType, setBusinessType] = useState<"lead_gen" | "ecommerce">(
    "lead_gen"
  );
  ...
  useEffect(() => {
    ...
    const currentRevenue =
      traffic * (conversionRate / 100) * valuePerLeadOrOrder;
      ...
      <div className="bg-gradient-to-br from-navy to-blue-900 rounded-3xl p-6 md:p-12 shadow-2xl border border-white/10 text-white">
        <div className="text-center mb-10">
          ...
          <p className="text-blue-100 max-w-2xl mx-auto">
            Calculate exactly how a high-performance, SEO-ready FactoryJet
            website pays for itself. Based on data from 500+ industrial
            projects.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-between">
            <div className="space-y-4">
              <h4 className="text-xl font-bold border-b border-white/10 pb-2 mb-4">
                Projected Growth with FactoryJet
              </h4>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-accent/10 p-4 rounded-lg border border-accent/20">
                  <div className="text-xs text-accent uppercase mb-1 font-bold">
                  ...
                  <div className="text-xs text-accent mt-1 flex items-center gap-1">
                    ...
                    {(
                      (results.monthlyGain / (results.currentRevenue || 1)) *
                      100
                    ).toFixed(0)}
                    % Lift
                  </div>
              ...
              <div className="bg-white/10 p-6 rounded-xl border border-white/20 mt-6">
                ...
                <p className="text-xs text-blue-200">
                  *Based on conservative estimates of 40% traffic lift (SEO/AEO)
                  and 50% conversion lift (UX/Speed).
                </p>
              </div>
            ...
            {!formSubmitted ? (
              <>
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-slate mt-2">
                    Get the detailed PDF breakdown sent to your email.
                  </p>
                </div>
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="w-full bg-primary hover:bg-navy text-white font-bold py-3 rounded-lg mt-2 transition-colors"
                  >
                    Download PDF Report
                  </button>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-slate mb-6">
                  Your detailed ROI report has been generated and sent to your
                  email address.
                </p>
                <button
                  onClick={() => {
    ...
    <section className="bg-white py-16 md:py-24" id="pricing">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <h2 className="text-3xl md:text-5xl font-bold text-navy text-center mb-3 font-heading leading-tight">
          Transparent, <span className="text-primary">Value-Driven</span>{" "}
          ...
          {activeTab === "website" && (
            <>
              ...
              <div className="w-full max-w-md mx-auto md:max-w-none border border-light rounded-2xl p-6 hover:shadow-xl transition-all duration-300 bg-white relative">
                <h3 className="text-primary font-bold uppercase tracking-wider text-sm mb-1">
                  Starter
                </h3>
                ...
                <button className="w-full py-3 rounded-lg border-2 border-primary text-primary font-bold hover:bg-primary hover:text-white transition-colors text-sm mb-8">
                  Select Plan
                </button>
              ...
              <div className="w-full max-w-md mx-auto md:max-w-none border-2 border-primary rounded-2xl p-6 shadow-xl relative bg-white transform md:-translate-y-4">
                ...
                <h3 className="text-primary font-bold uppercase tracking-wider text-sm mb-1 mt-2">
                  Business
                </h3>
                ...
                <button className="w-full py-3 rounded-lg bg-secondary text-white font-bold hover:bg-orange-600 transition-colors text-sm mb-8 shadow-lg shadow-orange-200">
                  Get Started Now
                </button>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="p-6 bg-bgLight rounded-xl border border-light text-center">
            <div className="font-bold text-xl text-navy mb-2">
              Pay-as-you-scale
            </div>
            <p className="text-slate text-sm">
              Upgrade/downgrade with no penalty.
            </p>
          </div>
          <div className="p-6 bg-bgLight rounded-xl border border-light text-center">
            <div className="font-bold text-xl text-navy mb-2">
            ...
            <p className="text-slate text-sm">
              Special requirements? We'll build you a plan.
            </p>
          </div>
          <div className="p-6 bg-bgLight rounded-xl border border-light text-center">
            <div className="font-bold text-xl text-navy mb-2">
            ...
            <p className="text-slate text-sm">
              Available for long-term partners.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {industries.map((ind, i) => (
            <div
              key={i}
              className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow flex flex-col items-center gap-4 border border-light"
            >
            ...
            >
              ...
              >
                ...
                <div className="text-sm text-slate-500 mb-6 font-medium">
                  {study.industry} | {study.services}
                </div>

                <div className="space-y-6">
                  <div>
                    <h4 className="font-bold text-navy text-sm uppercase mb-2">
                      Challenge
                    </h4>
                  ...
                  {study.testimonial && (
                    <div className="bg-bgLight p-4 rounded-lg border-l-4 border-secondary italic text-sm text-slate-600">
                      "{study.testimonial}"
                      <div className="mt-2 font-bold text-navy not-italic">
          ...
          {faqData.map((item, index) => (
            ...
            >
              <button
                ...
                className="w-full flex justify-between items-center p-5 text-left font-bold text-navy hover:bg-slate-50 transition-colors"
              >
                {item.question}
                {openIndex === index ? (
              ...
              {openIndex === index && (
                <div className="p-5 pt-0 text-slate text-sm leading-relaxed border-t border-light/50">
                  {item.answer}
                </div>
              )}
            </div>
