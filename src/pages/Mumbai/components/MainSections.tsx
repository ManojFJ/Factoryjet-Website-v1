       ...
       <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="bg-bgLight p-6 rounded-xl border border-light space-y-4">
               ...
               <p className="text-slate text-sm flex gap-2"><MapPin className="w-4 h-4 text-primary" /> Unit 501, Trade Centre, BKC, Mumbai, Maharashtra 400051</p>
    ...
    <section className="bg-gradient-to-r from-navy to-blue-900 py-24 text-white text-center">
       <div className="max-w-4xl mx-auto px-4">
         ...
         <div className="flex flex-col md:flex-row gap-6 justify-center mb-12">
            <button className="bg-secondary hover:bg-orange-600 text-white font-bold py-4 px-12 rounded-lg text-xl shadow-lg transition-transform hover:scale-105">🚀 Get Free Quote Today</button>
         ...
         <div className="bg-white/10 p-4 rounded-lg inline-block text-sm">
            ⚠️ Limited Availability: We accept only 10 new industrial projects per month to ensure quality. Currently [X] slots available for [Current Month].
         </div>
