...
const Pricing: React.FC<PricingProps> = ({ onOpenModal }) => {
  ...
  const websitePlans = [
    {
      name: 'STARTER',
      price: '₹29,999',
      description: 'Perfect for: New Pune businesses, freelancers, consultants',
      features: [
    ...
    },
    {
      ...
      features: [
        ...
        'Advanced Local SEO (Rank in Pune searches)',
  ...
  const ecommercePlans = [
    ...
    },
    {
      ...
      features: [
        'Up to 200 Products',
        'Abandoned Cart Recovery (saves revenue!)',
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 bg-jet-green/10 text-jet-green px-4 py-2 rounded-full text-sm font-bold">
            <Lock size={16} />
            Price Match Guarantee: Find a lower quote from a Pune agency? We'll match it.
          </div>
        </motion.div>
