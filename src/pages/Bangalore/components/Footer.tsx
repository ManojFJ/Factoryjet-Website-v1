        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12 mb-10 md:mb-16">
          ...
          <div>
            ...
            <p className="text-jet-gray text-sm leading-relaxed mb-6">
              Bangalore's trusted web design partner for SMBs. We build high-performance e-commerce and business websites that actually convert.
            </p>
          ...
          {/* Col 3 */}
          <div>
            <h4 className="font-bold text-lg mb-6">Bangalore Areas We Serve</h4>
