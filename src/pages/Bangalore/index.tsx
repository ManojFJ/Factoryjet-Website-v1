...
const BangalorePage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional website design & e-commerce development in Bangalore. Trusted by 200+ Karnataka businesses. 4-week delivery. Starting ₹29,999. Get free audit!');
    }
  }, []);
