...
export const caseStudiesData: CaseStudyItem[] = [
  {
    ...
    challenge: "Grofresh, a growing agritech and food processing company, was struggling with manual processes across finance, inventory, HR, and operations. Their existing website was outdated and not generating leads. Month-end closing took 15+ days.",
    solution: "FactoryJet implemented comprehensive digital transformation: Complete ERPNext implementation covering Finance & Accounting, Inventory, and Operations. Modern corporate website with lead generation optimization.",
    results: ["100% Business Digitization Achieved", "Month-end close reduced from 15 days to 2 days", "Real-time inventory tracking", "70% improvement in operational efficiency"],
    ...
    image: "https://images.unsplash.com/photo-1495107334309-fcf20504a5ab?q=80&w=2070&auto=format&fit=crop"
  },
  {
    ...
    challenge: "Bombay Petals needed to serve two distinct customer segments: wholesale B2B buyers and retail consumers. Managing two separate systems was inefficient, and they lacked a professional online presence.",
    solution: "FactoryJet developed a comprehensive dual e-commerce solution: B2B wholesale portal with volume pricing, credit terms, and bulk ordering. Beautiful DTC consumer store for retail customers. Unified inventory management.",
    results: ["₹1.5 Cr Sales in 12 Months", "40% Increase in B2B Orders", "Automated Shipping with Shiprocket", "Unified Inventory Management"],
    testimonial: "The dual-store strategy worked perfectly. We can now manage bulk wholesale orders and individual retail customers from a single dashboard. Our sales have doubled.",
    testimonialAuthor: "Priya Malhotra, Founder, Bombay Petals",
