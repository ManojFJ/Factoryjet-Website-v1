      ...
      features: [
        {
          ...
          items: ["5 Pages Custom Design", "WordPress/React Basics", "Mobile Responsive"]
        },
        {
          category: "SEO FOUNDATION",
          items: ["XML Sitemap Generation", "Basic Meta Tags", "Google Maps Integration"]
        },
        {
          category: "PERFORMANCE",
          items: ["Standard Caching", "Auto-Resize Images", "99% Uptime Hosting"]
        },
        {
          category: "SECURITY & CONVERSION",
          items: ["Standard HTTPS", "Basic Login Protection", "Click-to-Call Buttons"]
        }
      ]
    },
    {
      ...
      features: [
        {
          category: "CORE DEVELOPMENT",
          items: ["12 Custom Pages", "Hybrid AI Architecture", "Mobile-First Indexing", "Legacy Browser Support"]
        },
        {
          category: "ADVANCED SEO",
          items: ["Advanced Robots.txt", "Open Graph (Social) Tags", "Schema.org (JSON-LD)", "G-Business Profile Setup"]
        },
        {
          category: "PERFORMANCE 90+",
          items: ["Lighthouse Score 90+", "WebP Compression", "Cloudflare CDN Setup", "Database Query Opt"]
        },
        {
          category: "SECURITY SUITE",
          items: ["Military-Grade SSL", "Brute Force Protection", "ReCaptcha v3", "Daily Cloud Backups"]
        },
        {
          category: "CONVERSION TOOLS",
          items: ["Sticky Bottom Bar", "WhatsApp Widget", "Multi-Step Forms", "GA4 Analytics Setup"]
        }
      ]
    },
    {
      ...
      features: [
        {
          category: "CORE DEVELOPMENT",
          items: ["20+ Dynamic Pages", "Next.js / Headless Arch", "PWA Ready", "Retina Support"]
        },
        {
          category: "SEO DOMINANCE",
          items: ["Log File Analysis", "Twitter Cards", "Voice Search (AEO)", "Local Citations"]
        },
        {
          category: "PERFORMANCE",
          items: ["Core Web Vitals 'Green'", "Lazy Loading", "Global Edge Network", "Redis Object Caching"]
        },
        {
          category: "ENTERPRISE SECURITY",
          items: ["Wildcard SSL", "DDoS Mitigation", "Spam Firewall", "Real-Time Redundancy"]
        },
        {
          category: "GROWTH TOOLS",
          items: ["Exit Intent Popups", "AI Chatbot Ready", "CRM Integration", "Heatmaps"]
        }
      ]
    }
  ];
      ...
      features: [
        {
          ...
          items: ["20 Products Setup", "Standard Checkout", "Guest Checkout", "Basic Coupons"]
        },
        {
          category: "ESSENTIAL FEATURES",
          items: ["Star Ratings", "Basic Search", "Razorpay/UPI Integration", "Flat Rate Shipping"]
        },
        {
          category: "TECH SPECS",
          items: ["Simple Tax Setup", "Email Receipts", "Meta Titles", "Alt Tags"]
        }
      ]
    },
    {
      ...
      features: [
        {
          category: "STORE ARCHITECTURE",
          items: ["100 Products Setup", "Variable Products", "One-Page Checkout", "Customer Dashboard"]
        },
        {
          category: "MARKETING ENGINE",
          items: ["Dynamic Discounts", "Photo Reviews", "Abandoned Cart Email", "Related Products"]
        },
        {
          category: "PAYMENTS & LOGISTICS",
          items: ["Multi-Gateway (COD+CC)", "Live Shipping (Shiprocket)", "Auto GST Calc", "PDF Invoices"]
        },
        {
          category: "SEO & TECH",
          items: ["Product Schema", "Auto-Alt Tags", "High-Perf DB Mode", "Ajax Live Search"]
        },
        {
          category: "MANAGEMENT",
          items: ["Low Stock Alerts", "Advanced Sales Reports", "Order CSV Export"]
        }
      ]
    },
    {
      ...
      features: [
        {
          category: "STORE ARCHITECTURE",
          items: ["Unlimited Products", "Bundled/Digital Products", "Distraction-Free Checkout", "Social Login"]
        },
        {
          category: "MARKETING ENGINE",
          items: ["BOGO Logic", "Verified Badges", "SMS/WhatsApp Notifs", "In-Cart Upsells"]
        },
        {
          category: "GLOBAL PAYMENTS",
          items: ["International (Stripe)", "Pincode Check", "Multi-State Tax", "GST Tax Invoices"]
        },
        {
          category: "ADVANCED TECH",
          items: ["Google Merchant Feed", "Video Gallery", "Redis Caching", "AI Search & Filter"]
        },
        {
          category: "MANAGEMENT",
          items: ["Multi-Warehouse", "Cohort Analysis", "ERP API Ready"]
        }
      ]
    }
  ];
  ...
  const amcTiers: PricingTier[] = [
    ...
    },
    {
      ...
      features: [
        ...
        {
          category: "SECURITY",
          items: ["SSL Handshake Opt", "Daily Deep Scan", "Free Hack Cleanup", "Daily Cloud Backup"]
        },
        {
          category: "MAINTENANCE",
          items: ["Managed Safe Updates", "Plugin Compatibility", "Child Theme Maint", "Monthly DB Cleanup"]
        },
        {
          category: "PERFORMANCE",
          items: ["Monthly Core Web Vitals", "Broken Link Scan", "Bulk Image Compress"]
        },
        {
          category: "SUPPORT",
          items: ["24 Hr Response", "WhatsApp Support", "Quarterly Strategy Call"]
        }
      ]
    },
    {
      ...
      features: [
        {
          ...
          items: ["Real-Time Alerts", "Traffic Spike Mgmt", "Deep Server Audits"]
        },
        {
          category: "ELITE SECURITY",
          items: ["Advanced Cert Mgmt", "Real-time Firewall", "Insurance-Backed", "Hourly Backups"]
        },
        {
          category: "DEVOPS",
          items: ["Manual Verification", "Staging Tests", "Code Deprecation Fixes", "Query Opt"]
        },
        {
          category: "PERFORMANCE",
        ...
        },
        {
          ...
          items: ["4 Hr Priority", "Dedicated Manager", "Monthly Strategy Call"]
        }
      ]
    }
  ];
