...
import {
  Check, Star, Shield, HelpCircle, ChevronDown, CheckCircle2,
  Lightbulb, Cpu, ShoppingBag, LifeBuoy, Plus, Minus, ArrowRight
} from 'lucide-react';
...
const DATA_WEBSITE: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      {
        category: 'CORE',
        features: ['12 Pages', 'Hybrid AI Architecture', 'Mobile-First Indexing', 'Legacy Browser Support']
      },
      {
        category: 'SEO',
        features: ['Advanced Robots.txt', 'Open Graph Tags', 'Schema.org (JSON-LD)', 'G-Business Profile']
      },
      {
        category: 'PERFORMANCE',
        features: ['Lighthouse 90+', 'WebP Compression', 'Cloudflare CDN', 'Database Query Opt']
      },
      {
        category: 'SECURITY',
        features: ['Military-Grade SSL', 'Brute Force Protection', 'ReCaptcha v3', 'Daily Cloud Backups']
      },
      {
        category: 'CONVERSION',
        features: ['Sticky Bottom Bar', 'WhatsApp Widget', 'Multi-Step Forms', 'GA4 Setup', 'Insta Feed']
      },
      {
        category: 'HOSTING',
        features: ['99.9% Uptime', 'Unmetered Bandwidth', '5 Business Emails']
      }
    ]
  },
  {
    ...
    features: [
      {
        category: 'CORE',
        features: ['20+ Dynamic Pages', 'Next.js/Headless', 'PWA Ready', 'Retina Support']
      },
      {
        category: 'SEO',
        features: ['Log File Analysis', 'Twitter Cards', 'Voice Search (AEO)', 'Local Citations']
      },
      {
        category: 'PERFORMANCE',
        features: ['Core Web Vitals "Green"', 'Lazy Loading', 'Global Edge Network', 'Redis Object Caching']
      },
      {
        category: 'SECURITY',
        features: ['Wildcard SSL', 'DDoS Mitigation', 'Enterprise Spam Firewall', 'Real-Time Redundant Backups']
      },
      {
        category: 'CONVERSION',
        features: ['Exit Intent Popups', 'AI Chatbot Ready', 'CRM Integration', 'Heatmaps', 'Auto-Social Posting']
      },
      {
        category: 'HOSTING',
        features: ['99.99% Uptime', 'High-Frequency Compute', 'Unlimited G-Suite Emails']
      }
    ]
  }
];
...
const DATA_ECOMMERCE: PricingTier[] = [
    ...
    features: [
      {
        ...
        features: [
          '20 Products', 'Standard Checkout', 'Guest Checkout', 'Basic Coupons', 
          'Star Ratings', 'Basic Search', 'Razorpay/UPI', 'Flat Rate Shipping', 
          'Simple Tax', 'Email Receipt', 'Meta Titles', 'Alt Tags'
        ]
      }
    ]
  },
  {
    ...
    features: [
      {
        category: 'ARCH',
        features: ['100 Products', 'Variable Products', 'One-Page Checkout', 'Customer Dashboard']
      },
      {
        category: 'MARKETING',
        features: ['Dynamic Discounts', 'Photo Reviews', 'Abandoned Cart Email', 'Related Products', 'Ajax Live Search']
      },
      {
        category: 'PAYMENTS',
        features: ['Multi-Gateway (COD+Credit)', 'Live Shipping Rates (Shiprocket)', 'Auto GST Calc', 'PDF Invoices']
      },
      {
        category: 'SEO/TECH',
        features: ['Product Schema', 'Auto-Alt Tags', 'High-Perf Database mode']
      },
      {
        category: 'MGMT',
        features: ['Low Stock Alerts', 'Advanced Sales Reports', 'Order CSV Export']
      }
    ]
  },
  {
    ...
    features: [
      {
        category: 'ARCH',
        features: ['Unlimited Products', 'Bundled/Digital', 'Distraction-Free Checkout', 'Social Login']
      },
      {
        category: 'MARKETING',
        features: ['BOGO Logic', 'Verified Badges', 'SMS/WhatsApp Notifs', 'In-Cart Upsells', 'AI Search & Filter']
      },
      {
        category: 'PAYMENTS',
        features: ['International (Stripe)', 'Pincode Check', 'Multi-State Tax', 'GST Tax Invoices']
      },
      {
        category: 'SEO/TECH',
        features: ['Google Merchant Feed', 'Video Gallery', 'Redis Caching for Store']
      },
      {
        category: 'MGMT',
        features: ['Multi-Warehouse', 'Cohort Analysis', 'ERP API Ready']
      }
    ]
  }
];
...
const DATA_AMC: PricingTier[] = [
    ...
    features: [
      {
        ...
        features: [
          '24/7 Ping Monitor', 'SSL Renewal', 'Weekly Scan', 'Paid Hack Recovery', 'Weekly DB Backup', 'Auto-Updates'
        ]
      }
    ]
  },
  {
    ...
    features: [
      {
        category: 'HEALTH',
        features: ['24/7 HTTP Monitor', 'CPU/RAM Tracking', 'Monthly Error Log']
      },
      {
        category: 'SECURITY',
        features: ['SSL Handshake Opt', 'Daily Deep Scan', 'Free Hack Cleanup', 'Daily Cloud Backup']
      },
      {
        category: 'MAINTENANCE',
        features: ['Managed Safe Updates', 'Plugin Compatibility', 'Child Theme Maint', 'Monthly DB Cleanup']
      },
      {
        category: 'PERFORMANCE',
        features: ['Monthly Core Web Vitals', 'Broken Link Scan', 'Bulk Image Compress']
      },
      {
        category: 'SUPPORT',
        features: ['24 Hr Response', 'WhatsApp Support', 'Quarterly Strategy Call']
      }
    ]
  },
  {
    ...
    features: [
      {
        category: 'HEALTH',
        features: ['Real-Time Alerts', 'Traffic Spike Mgmt', 'Deep Server Audits']
      },
      {
        category: 'SECURITY',
        features: ['Advanced Cert Mgmt', 'Real-time Firewall', 'Insurance-Backed Guarantee', 'Hourly Backups']
      },
      {
        category: 'MAINTENANCE',
        features: ['Manual Verification', 'Staging Tests', 'Code Deprecation Fixes', 'Query Opt']
      },
      {
        category: 'PERFORMANCE',
      ...
      {
        category: 'SUPPORT',
        features: ['4 Hr Priority', 'Dedicated Manager', 'Monthly Strategy Call']
      }
    ]
  }
];
...
const FAQ_DATA = [
  {
    ...
    icon: Lightbulb,
    items: [
      { q: "Who is FactoryJet strictly designed for?", a: "We build specifically for ambitious SMBs and manufacturers in India who want to move beyond 'brochureware' sites. If you need complex integrations, high performance, and a system that generates leads, we are your partner." },
      { q: "Do you work with early-stage startups?", a: "Yes, but usually those with seed funding or a clear revenue model. Our 'Starter' plans are great for validation, while our 'Enterprise' stacks are for scaling. We don't typically do 'hobby' projects." },
      { q: "How are you different from a freelancer on Upwork?", a: "Reliability and Architecture. A freelancer fixes a task; we build a system. We provide a full team (Designer, Dev, SEO Specialist) and guarantee uptime, security, and code quality that a single person cannot scale." },
      { q: "What is the typical timeline for a 'Business' plan?", a: "Usually 4-6 weeks. Week 1 is Discovery/Design. Weeks 2-4 are Development & Integration. Week 5 is QA/Testing. Week 6 is Launch & Handover." },
      { q: "Do I own the Intellectual Property (IP)?", a: "100%. Once the final invoice is cleared, you receive full code ownership, database access, and creative assets. We don't believe in holding clients hostage." }
    ]
  },
  {
    id: 'technical',
    ...
    icon: Cpu,
    items: [
      { q: "What do you mean by 'Hybrid AI Architecture'?", a: "We use AI agents to dynamically generate schema markup, optimize image alt-text, and structure your content for Voice Search (AEO). It’s SEO on autopilot, baked into the code." },
      { q: "Why use Next.js over standard WordPress?", a: "Speed and Security. Next.js (React) renders pages instantly and is much harder to hack because it separates the frontend from the backend. It's the standard for modern enterprise web." },
      { q: "Will my website pass Google's Core Web Vitals?", a: "Yes, that is a contractual deliverable. We aim for 90+ scores on mobile. We use aggressive caching, image compression, and code splitting to ensure green scores." },
      { q: "How secure are your servers?", a: "We use enterprise-grade cloud architecture (DigitalOcean/AWS) with WAF (Web Application Firewalls), DDoS mitigation, and daily off-site backups. It's bank-grade security for your business." },
      { q: "Can I host this on my own AWS account?", a: "Absolutely. While we offer managed hosting for ease, we can deploy the entire stack to your personal AWS, Google Cloud, or Azure instance during the handover phase." }
    ]
  },
  {
    id: 'ecommerce',
    ...
    icon: ShoppingBag,
    items: [
      { q: "Can you migrate me from Shopify to WooCommerce?", a: "Yes. Many clients switch to save on the monthly transaction fees. We migrate all products, customers, and order history while preserving your SEO rankings." },
      { q: "Which payment gateways do you support?", a: "All major Indian and International gateways: Razorpay, Stripe, PhonePe, Paytm, and PayPal. We also configure COD with OTP verification to reduce returns." },
      { q: "How do you handle 'High Traffic' events?", a: "Our Enterprise stacks use Redis Object Caching and CDN Edge Networks. This means your site can handle thousands of concurrent users during a sale without crashing." },
      { q: "Is the inventory synced with my offline ERP?", a: "In the Enterprise plan, yes. We can build custom APIs to sync your website inventory with Tally, Zoho Books, or custom ERPs." },
      { q: "Do you support multi-vendor marketplaces?", a: "Yes, we can build Amazon-style marketplaces where other vendors sign up and sell, but this requires a custom quote beyond our standard pricing cards." }
    ]
  },
  {
    id: 'support',
    ...
    icon: LifeBuoy,
    items: [
      { q: "What happens if my site breaks at 2 AM?", a: "If you are on the 'Growth' or 'VIP' AMC plan, our uptime monitors alert us instantly. We have a 24/7 response protocol to get you back online before you even wake up." },
      { q: "Is the AMC mandatory?", a: "No. It is highly recommended for security and peace of mind, but if you have an internal IT team, we are happy to hand over the documentation and keys to them." },
      { q: "How do you update content on my site?", a: "We build custom, simplified Admin Dashboards. You don't need to know code to change a price, update a blog, or change a banner. It's as easy as posting on Facebook." },
      { q: "Do you offer refunds?", a: "We have a milestone-based refund policy. If you cancel during the Design Phase, you only pay for the design. Once coding begins, refunds are pro-rated based on work completed." },
      { q: "Can I upgrade from 'Starter' to 'Business' later?", a: "Yes! Since we build modularly, upgrading is usually just a matter of adding the new features and paying the difference in tier price." }
    ]
  }
];
...
const PricingCard: React.FC<{ tier: PricingTier; onSelectPlan: () => void }> = ({ tier, onSelectPlan }) => {
  return (
    <motion.div
...
const FactoryJetPricing = () => {
  ...
  const getData = () => {
    switch(activeTab) {
      case 'ecommerce': return DATA_ECOMMERCE;
      case 'amc': return DATA_AMC;
      default: return DATA_WEBSITE;
    }
  };
