...
const ServiceLocationPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{`${primaryKeyword} | FactoryJet - Fast, Affordable & Results-Driven`}</title>
        <meta name="description" content={metaDescription} />

        {/* Primary Keywords */}
        <meta name="keywords" content={[primaryKeyword, ...secondaryKeywords, ...semanticKeywords.slice(0, 10)].join(', ')} />

        {/* Open Graph */}
        <meta property="og:title" content={`${primaryKeyword} | FactoryJet`} />
        <meta property="og:description" content={metaDescription} />
        <meta property="og:url" content={`https://factoryjet.com/services/${service}/${city}`} />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://factoryjet.com/FinalLogo.svg" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`${primaryKeyword} | FactoryJet`} />
        ...
        <nav aria-label="Breadcrumb" className="bg-gray-50 py-3 border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ol className="flex items-center space-x-2 text-sm">
              <li>
                <Link to="/" className="text-jet-blue hover:text-jet-navy transition-colors">
                  Home
                </Link>
              </li>
              <li className="text-gray-400">/</li>
              <li>
                <Link to="/#services" className="text-jet-blue hover:text-jet-navy transition-colors">
                  Services
                </Link>
              </li>
              <li className="text-gray-400">/</li>
