  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        {/* Emergency Section */}
        <div className="mb-16 bg-red-50 border border-red-100 rounded-2xl p-8 lg:p-10 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-red-800">Emergency Support (Critical Issues)</h2>
            </div>
        ...
        <h2 className="text-3xl font-display font-bold text-slate-900 mb-8 text-center">Already Working With Us?</h2>
