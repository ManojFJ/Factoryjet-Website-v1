        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 border-b border-slate-800 pb-12">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button className="bg-jetBlue hover:bg-blue-600 px-4 py-2 rounded text-white font-medium">Join</button>
            </div>
          </div>
        </div>

        <div className="text-center text-slate-500 text-sm flex flex-col md:flex-row justify-between items-center gap-4">
