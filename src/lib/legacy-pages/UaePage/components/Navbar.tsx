        ...
        <div className="flex justify-between items-center h-full">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4 ml-4">
              ...
              <a href="tel:+919699977699" className="flex items-center gap-2 text-sm font-semibold hover:text-gold transition-colors text-white">
                <Phone size={16} />
        ...
        <div className="lg:hidden absolute top-16 left-0 w-full bg-navy/95 backdrop-blur-xl border-b border-white/10 pb-6 px-4 shadow-2xl">
          <div className="flex flex-col space-y-4 pt-4">
            ...
            <div className="pt-4 space-y-3">
              ...
              <a href="tel:+919699977699" className="flex items-center justify-center gap-2 w-full py-3 bg-white/5 text-white rounded-lg font-semibold hover:bg-white/10 transition-colors">
