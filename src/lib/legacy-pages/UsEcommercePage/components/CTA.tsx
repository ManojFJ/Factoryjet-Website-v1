    ...
    <section id="cta" className="relative py-24 bg-gradient-to-br from-jet-blue to-blue-900 text-white overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
         ...
         <div className="pt-8 border-t border-blue-800/50 flex flex-col md:flex-row justify-center gap-8 text-sm text-blue-200">
           <a href="https://wa.me/919699977699" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
             <span className="inline-flex items-center gap-2">
               ...
               <strong>WhatsApp:</strong> +91 96999 77699
             </span>
           </a>
           <a href="mailto:connect@factoryjet.com" className="hover:text-white transition-colors">📧 <strong>Email:</strong> connect@factoryjet.com</a>
