    ...
    <section className="py-16 md:py-24 bg-gradient-to-br from-jet-blue to-[#003d99] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Ready to Grow Your Pune Business Online?
          </motion.h2>
          ...
          >
            Join 200+ Pune SMBs who've transformed their digital presence with FactoryJet. Get your free website audit today—no strings attached.
          </motion.p>
          ...
          >
            <a
              href="https://wa.me/919699977699?text=Hi%20FactoryJet%20Pune"
