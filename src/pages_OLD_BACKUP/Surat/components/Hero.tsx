...
const Hero: React.FC<HeroProps> = ({ onOpenModal }) => {
  const trustIndicators = [
    'Trusted by 200+ Surat businesses',
    '4-week delivery guarantee',
    'Dedicated Surat-based team',
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[calc(100vh-100px)]">
          ...
          <div className="order-2 lg:order-1">
            ...
            >
              Professional web design and e-commerce development launching in 4 weeks. Trusted by 200+ SMBs across Surat, Navsari & South Gujarat.
            </motion.p>
