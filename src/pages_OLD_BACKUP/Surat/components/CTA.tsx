...
const CTA: React.FC<CTAProps> = ({ onOpenModal }) => {
  ...
  const handleQuickSubmit = async () => {
    ...
    try {
      ...
      await setDoc(doc(db, 'surat_leads', docId), {
        whatsapp: `+91${whatsapp}`,
        createdAt: serverTimestamp(),
        status: 'new',
        source: 'surat_cta_quick',
      });
      setIsSuccess(true);
    } catch (err) {
    ...
    <section className="py-16 md:py-24 bg-gradient-to-br from-jet-blue to-[#003d99] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Ready to Grow Your Surat Business Online?
          </motion.h2>
          ...
          >
            Join 200+ Surat SMBs who've transformed their digital presence with FactoryJet. Get your free website audit today—no strings attached.
          </motion.p>
